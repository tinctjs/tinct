// Vendored dev-only test oracle: reference ThumbHash implementation.
// Source: https://github.com/evanw/thumbhash (MIT © 2023 Evan Wallace).
// Used exclusively to verify tinct's independent implementation in tests;
