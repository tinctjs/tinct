...
| **Booth** (`booth/`)                 | [imagepipe.github.io/imagepipe/booth](https://imagepipe.github.io/imagepipe/booth/)                 | Live pipelines + tracked face effects: webcam filters at 60 fps, landmark-driven warps and stickers via a MediaPipe `LandmarkProvider`, and snapshots that replay the same recipe through the still pipeline |
